...
\begin{abstract}
El trabajo centra sus esfuerzos en el desarrollo de una herramienta gratuita de código abierto
...
El principal objetivo del proyecto es proporcionar una herramienta intuitiva para personas con un conocimiento base del deporte, 
...
\begin{figure}[ht]
  \centering
  \fbox{\parbox{.85\linewidth}{\centering\textit{[Pipeline diagram: LR MRI → SR reconstruction → segmentation]}}}
...
\begin{figure}[ht]
  \centering
  \fbox{\parbox{.9\linewidth}{\centering\textit{[Axial slices: LR input, SR output, and segmentation overlay]}}}
